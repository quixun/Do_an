                        ...
                        @foreach ($edit_product as $key => $pro)
                            <form role="form" action="{{ URL::to('/update-product/' . $pro->product_id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name" class="formcontrol" id="exampleInputEmail1"
                                        value="{{ $pro->product_name }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Slug</label>
                                    <input type="text" name="product_slug" class="formcontrol" id="exampleInputEmail1"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Mô tả sản
                                        phẩm</label>
                                    <textarea style="resize: none" rows="8" class="formcontrol" name="product_desc" id="exampleInputPassword1">{{ $pro->product_desc }}</textarea>
                                </div>
                                <div class="form-group">
...
m-bot15">
                                ...
                                <button type="submit" name="add_product" class="btn btn-info btn-round">Cập nhật sản phẩm</button>
                            </form>
                        @endforeach
                    </div>
                </div>
