...
class BrandController extends Controller
{
    ...
    public function all_brand_product()
    {
        ...
        return view('admin_layout.admin_layout')->with(
            'admin.brand.all_brand_product',
    ...
    public function edit_brand_product($brand_product_id)
    {
        ...
        return view('admin_layout.admin_layout')->with('admin.brand.edit_brand_product', $manager_brand_product);
    }
    ...
    public function show_brand_home(Request $request, $brand_slug){
        ...
        return view('pages.home')->with('category',$cate_product)->with('brand',$brand_product)->with('brand_by_id',$brand_by_id)->with('brand_name',$brand_name);
        }
}
